...
namespace PhotographyBusiness.MockData
{
    public class MockBookings
    {
        ...
        private static List<Booking> Acceptedbookings = new List<Booking>()
        {
        ...
        public static List<Booking> GetAllRequestsMockBookings()
        {
            return BookingRequests;
        }

        public static List<Booking> GetAllAcceptedMockBookings() 
        {
