...
namespace PhotographyBusiness.MockData
{
    public class MockBookings
    {
        ...
        {
            new Booking("Marriage", 100, "Please give me photos :3", "Yaaaah :3", new DateTime (2023,03,12,14,15,00), new DateTime (2023,03,13), true, "Mrs Rasho 71 Cherry Court SOUTHAMPTON SO53 5PD UK", new User(4,"RashoRasho@hotmail.com", "123","Rasho Rash", "Rasho123"),userId: 4) {BookingId = 11,UserId = 4},
            new Booking("Family", 200, "I need 200 photos during 2 hours and if it's possible to film two so I will be great full", "aight bet", new DateTime(2023,04,15,16,30,00), new DateTime (2023,04,18), true, "Mock Address", new User(3,"Silas@outlook.com", "tyler1", "Silas Silas", "42791451"),userId:3){BookingId = 22,UserId=3},
            new Booking("Portrait", 300, "I need 200 photos during 2 hours and if it's possible to film two so I will be great full", "Ok", new DateTime(2023,06,2,20,00,00), new DateTime (2024,04,18), true, "Mrs Rasho 150 Cherry Court SOUTHAMPTON SO53 5PD UK", new User(4,"RashoRasho@hotmail.com", "123","Rasho Rash", "Rash321"),userId:4){BookingId = 33,UserId =4},
